...
const CalendarIntegration = function () {
    ...
    return (
        <div className='calendar-integration-container'>
            ...
            <button className="connect-calendar-button" onClick={`window.location.href = ${googleCalendarAuthURLQuery.data.addGoogleCalendarIntegration}`}>Connect Calendar!</button>
        </div>
    );
};
